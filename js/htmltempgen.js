$(document).ready(function(){
	var appName = 'HTML5 Template Generator v0.2.7';	// Application name and version number.
	...
	// ----------------------------------------------
	var doctype = '<!DOCTYPE html>';					// Doctype.
	var htmlTags = {begin:'<html>', end:'</html>'};		// Html open and close.
	var headTags = {begin:'<head>', end:'</head>'};		// Head open and close.
	var bodyTags = {begin:'<body>', end:'</body>'};		// Body open and close.
	var titleTags = {begin:'<title>', end:'</title>'};	// Title open and close.
	...
	// Adds the specified number of spaces before a given string.
	function pad(str,indentValue){	return Array(indentValue+1).join(" ")+str;	}
	// Template variables
